...
class network_wrapper(nn.Module):
    ...
    def load_args_se(self):
        ...
        self.config_path = os.path.join(
            os.path.dirname(__file__), "config/inference/" + self.model_name + ".yaml"
        )
    ...
    def load_args_sr(self):
        ...
        parser.add_argument(
            "--config_json", type=str, help="Path to the config.json file"
        )
        parser.add_argument(
            "--mode", type=str, default="inference", help="Modes: train or inference"
        )
        parser.add_argument(
            ...
            dest="checkpoint_dir",
            type=str,
            default="checkpoints/MossFormer2_SR_48K",
            help="Checkpoint directory",
        )
        parser.add_argument(
            "--input-path",
            dest="input_path",
            type=str,
            help="Path for low-resolution audio input",
        )
        parser.add_argument(
            "--output-dir",
            dest="output_dir",
            type=str,
            help="Directory for enhanced high-resolution audio output",
        )
        parser.add_argument(
            "--use-cuda",
            dest="use_cuda",
        ...
        parser.add_argument(
            "--network",
            type=str,
            help="Select SR model(currently supports MossFormer2_SR_48K)",
        )
        parser.add_argument(
            "--sampling-rate",
            dest="sampling_rate",
